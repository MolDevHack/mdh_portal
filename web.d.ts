...
declare namespace $.$$ {
    class $piterjs_app extends $.$piterjs_app {
        ...
        pages(): ($mol_page | $piterjs_meetup_page | $piterjs_speech_page | $piterjs_video_page | $piterjs_place_page | $piterjs_others)[];
        title(): string;
        meetups(): $piterjs_meetup[];
...
declare namespace $ {
    class $psb_ui_chart extends $mol_chart {
        series_x(val?: any): readonly number[];
        graphs(): readonly any[];
        series_fact(val?: any): readonly number[];
        Fact_fill(): $$.$mol_plot_fill;
        Fact_line(): $$.$mol_plot_line;
        Fact_dots(): $$.$mol_plot_dot;
        Fact(): $$.$mol_plot_group;
        series_plan(val?: any): readonly number[];
...
declare namespace $ {
    class $psb_portal extends $mol_book2 {
        ...
        Menu_items(): $$.$mol_list;
        stats_years(): readonly number[];
        stats_plan(): readonly number[];
        stats_fact(): readonly number[];
        Stats(): $psb_ui_chart;
        Menu_title(): $mol_view;
        Menu_tools(): $mol_view;
        Menu(): $$.$mol_page;
...
declare namespace $.$$ {
    class $psb_portal extends $.$psb_portal {
        app(): string | null;
        menu_items(): $mol_view[];
        pages(): ($mol_frame | $mol_page | $piterjs_meetup_page | $piterjs_speech_page | $piterjs_video_page | $piterjs_place_page | $piterjs_others | $hyoo_calc)[];
